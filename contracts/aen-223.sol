...
* @dev ERC-223 Token Standard Compliant
 ...
 * @dev Code based on Dexaran's one on github as recommended on ERC223 discussion
 */
contract AENToken is ERC223Interface {

  using SafeMath for uint256;

  mapping(address => uint256) balances;

  string public name    = "AEN Coin";
  string public symbol  = "AEN";
  uint8 public decimals = 8;
  uint256 public totalSupply = 400000000000000000;

  // ------------------------------------------------------------------
  // Constructor. Do not change this to constructore as suggested by Remix
  function AENToken() public
  {
    bytes memory empty;
